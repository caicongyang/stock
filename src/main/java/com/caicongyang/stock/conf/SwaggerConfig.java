...
public class SwaggerConfig {
    ...
    public Docket createRestApi() throws IOException {
        return new Docket(DocumentationType.SWAGGER_2).enable(swaggerEnableFlag).apiInfo(apiInfo()).select().apis(RequestHandlerSelectors.basePackage("com.caicongyang.stock.controllers")).paths(PathSelectors.any()).build();
    }
